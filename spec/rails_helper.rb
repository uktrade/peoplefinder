...
RSpec.configure do |config|
  ...
  DatabaseCleaner.url_whitelist = [
    # Development is not used in test environment, DB_TEST_URL is used instead.
    # But `database_cleaner` is not smart enough to know that...
    'postgres://postgres:postgres@db/peoplefinder_development',
    'postgres://postgres:postgres@db/peoplefinder_test'
  ]
